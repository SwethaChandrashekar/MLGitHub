...
getwd()
setwd("C:/Users/shuvi/Desktop/CMS/Sem 3/ML")

#Importing CSV file in R
readLines(con='German-Credit-1.csv',n=5)
df1=read.table(file='German-Credit-1.csv',header=T,sep=',')
head(df1)
df1=read.csv(file='German-Credit-1.csv',header=T)
head(df1)
df2=read.csv(file='German-Credit-2.csv',header=T)
head(df2)
